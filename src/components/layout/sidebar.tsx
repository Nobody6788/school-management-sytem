...
const menuItems = [
  ...
  { href: '/teacher-dashboard', label: 'Teacher Dashboard', icon: UserSquare },
  ...
  { href: '/teacher-dashboard/teachers', label: 'Teachers', icon: UsersRound },
  ...
  { href: '/student-dashboard', label: 'Student Dashboard', icon: Home },
  ...
  { href: '/parent-dashboard', label: 'Parent Dashboard', icon: ShieldCheck },
