...
import { studentPersonalEvents as initialEvents, students } from '@/lib/data';
...
export default function StudentPersonalCalendarPage() {
    ...
    <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
      <Card className="lg:col-span-1">
        <CardHeader>
          ...
          <CardDescription>Select a date to view or add your personal events.</CardDescription>
        </CardHeader>
